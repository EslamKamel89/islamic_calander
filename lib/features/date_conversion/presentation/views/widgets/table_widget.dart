...
import 'package:islamic_calander/features/date_conversion/presentation/views/widgets/conversion_date_info_loading_widget.dart';
      ...
      builder: (context) {
        return BlocBuilder<DateConversionCubit, DateConversionState>(
          builder: (context, state) {
            ...
            } else if (state.getSelectedDateInfoState ==
